...
import model.TimerTaskAndAlarmSettled
import repository.ALARM_RW_DEFAULT_DAY
import repository.ALARM_RW_DEFAULT_HOUR
import repository.ALARM_RW_DEFAULT_MINUTE
...
object ScheduleUtils {
    ...
    fun getTimerTask(alarmRaceWeek: AlarmRaceWeek, notifyRace: () -> Unit): TimerTaskAndAlarmSettled {
        val dayOfWeek = getDayOfWeek(alarmRaceWeek.day ?: ALARM_RW_DEFAULT_DAY)
        val hour = alarmRaceWeek.hour ?: ALARM_RW_DEFAULT_HOUR
        val minute = alarmRaceWeek.minute ?: ALARM_RW_DEFAULT_MINUTE
        ...
        return TimerTaskAndAlarmSettled(timerTask, alarmSettled)
    }
